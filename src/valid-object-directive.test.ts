...
import { ValidObjectDirective } from "./valid-object-directive"

const directive = new ValidObjectDirective()
...
describe("@validObject directive", () => {
    ...
    const schema = getSchema(
      gql`
        ...
        type Query {
          testQuery(
            arg: TestQueryInput!
              @validObject(nonEqualFields: ["string1", "string2", "string3"])
          ): Boolean!
        }
      `,
      {
